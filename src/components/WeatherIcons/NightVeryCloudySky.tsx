...
interface NightVeryCloudySkyProps {}

const NightVeryCloudySky: React.FC<NightVeryCloudySkyProps> = () => (
  <motion.svg
    initial="hidden"
    animate="visible"
    version="1.1"
    ...
    <g>
      ...
      <motion.g>
        <motion.path
          ...
          variants={positionVariants('x', -30)}
          fill="#DFE0E1"
        ...
        <motion.path
          ...
          d="M48.667,28.938c-0.63,0-1.229,0.104-1.812,0.252c-1.48-2.874-4.476-4.842-7.932-4.842
              ...
              c0,3.584,2.907,6.491,6.492,6.491h0.981h19.115h0.183c4.036,0,7.305-3.271,7.305-7.305C55.967,32.211,52.698,28.938,48.667,28.938z"
...
export default React.memo(NightVeryCloudySky);
